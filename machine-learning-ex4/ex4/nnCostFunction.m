...
for t=1:m,
	...
	a2 = [1 ; a2]; % adding bias (26*1)
		...
		a3 = sigmoid(z3); % final activation layer a3 == h_theta (10*1)
	...
	% step 4
		...
		Theta2_grad = Theta2_grad + delta3*a2'; % (10*1)*(1*25)
		Theta1_grad = Theta1_grad + delta2*a1'; % (26*1)*(1*401)
